...
int main( int argc, char** argv ) {
    ...
    Eigen::Tensor<float, 4> in = io::load_kernel_weight_4d("../data/io_data/input.tensor");
    Eigen::Tensor<float, 4> ou = io::load_kernel_weight_4d("../data/io_data/conv2d_1_output");
    Eigen::Tensor<float, 4> ke = io::load_kernel_weight_4d("../data/tensor_weights/conv2d_1_kernel.kw");
    Eigen::Tensor<float, 1> bi = io::load_kernel_weight_1d("../data/tensor_weights/conv2d_1_bias.kw");
